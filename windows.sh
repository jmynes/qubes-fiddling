...
################################################
#
#echo -e "\n[dom0 - windows.sh]: Setting up a DisposableVM, downloads-dispvm, for downloading things in this script"
...
echo -e "\n[dom0 - windows.sh]: Set [personal] qube to 20GiB of private storage"
qvm-volume resize personal:private 20GiB

echo -e "\n[personal - windows.sh]: Download qvm-create-windows-qube from github as zip file"
qvm-run --pass-io personal "curl -L -O https://github.com/ElliotKillick/qvm-create-windows-qube/archive/refs/heads/master.zip"

echo -e "\n[personal - windows.sh]: Cat zip file, outputting its contents into [dom0]; then, delete it from [personal] qube"
qvm-run --pass-io personal "cat ~/master.zip" > master.zip
qvm-run --pass-io personal "rm ~/master.zip"

echo -e "\n[dom0 - windows.sh]: Unzipping, then removing master.zip"
unzip master.zip
rm master.zip

echo -e "\n[dom0 - windows.sh]: Setting install.sh to be executable, then running it to set up windows-mgmt"
chmod +x ./qvm-create-windows-qube-master/install.sh
./qvm-create-windows-qube-master/install.sh

#echo -e "\n[dom0 - windows.sh]: Copying mido.sh to [downloads-dispvm]"
#qvm-copy-to-vm downloads-dispvm ./qvm-create-windows-qube-master/windows/isos/mido.sh

echo -e "\n[dom0 - windows.sh]: Copying mido.sh to [personal] qube"
qvm-copy-to-vm personal ./qvm-create-windows-qube-master/windows/isos/mido.sh

read -p "\n[dom0 - windows.sh]: Since mido.sh isn't working lately, make sure to go download a Win10x64-pro.iso from Microsoft or Archive.org. Please press enter to continue when ready..."

#echo -e "\n[personal - windows.sh]: Download Win10x64-pro.iso from mido.sh"
...
echo -e "\n[dom0 - windows.sh]: Using [windows-mgmt] to install [win10-pro] TemplateVM, with packages: firefox, notepad++, office 365 Pro Plus, git, python3, 7zip, dotnet 6.0, steam"
